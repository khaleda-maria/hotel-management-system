...
<?php
if (isset($_POST['btn'])) {
    $message = $obj_admin->add_room_info($_POST);
}
...
<div class="row-fluid sortable">
    <div class="box span12">
        <div class="box-header" data-original-title>
            <h2><i class="halflings-icon edit"></i><span class="break"></span>Add Rooms Here</h2>
            <div class="box-icon">
            ...
            <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                <fieldset>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text"style="background-color:#b3ccff ;width:50%" name="room_name" class="span">
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label btn" for="typeahead">Room Number </label>
                        <div class="controls">
                            <input type="number"style="background-color:#b3ccff ;width:50%" name="room_num" class="span">
                        </div>
                    </div>
                    ...
                    <div class="control-group hidden-phone">
                        ...
                        <div class="controls ">
                            <textarea  id="" rows="8" style="background-color:  #b3ccff; width: 50%" name="room_short_des"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="control-group hidden-phone">
                        ...
                        <div class="controls ">
                            <textarea  id="" rows="8" style="background-color:  #b3ccff; width: 50%" name="room_long_des"></textarea>
                        </div>
                    </div>
                             <div class="control-group">
                        <label class="control-label" for="focusedInput">Room Price</label>
                        <div class="controls">
                            <input style="background-color:#b3ccff ;width:50% " class="input focused" id="focusedInput" type="file" name="room_price">
                        </div>
                    </div>
